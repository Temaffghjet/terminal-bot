            ...
            for prof in profiles:
                ...
                for pr in pairs:
                    ...
                    try:
                        ...
                        # Не fetch_ticker: в ccxt HL он вызывает fetch_markets → пачка POST /info и 429
    ...
    if es0.get("enabled"):
        ...
        if exn == "hyperliquid":
            try:
                ...
                logger.info("Hyperliquid (EMA): load_markets() выполнен — тикер не дёргает /info пачками")
